...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(DriverActivity.this, android.R.layout.simple_list_item_1, distances);
        ...
        if(requestCode == REQUEST_CODE) {
            if(grantResults != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if(ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(DriverActivity.this, "Location Permission is NOT granted.", Toast.LENGTH_SHORT).show();
                }
            }
        } else {
...
//            final ProgressDialog progressDialog = new ProgressDialog(DriverActivity.this, R.style.Theme_AppCompat_DayNight_Dialog);
...
//                        progressDialog.dismiss();
                        ...
                        Toast.makeText(DriverActivity.this, "No active nearby requests. Please try again later.", Toast.LENGTH_SHORT).show();
                    }
                    adapter.notifyDataSetChanged();
                }
            });
        } else {
            Toast.makeText(DriverActivity.this, "Your current location is not found. Please try again later.", Toast.LENGTH_SHORT).show();
        }
    }
